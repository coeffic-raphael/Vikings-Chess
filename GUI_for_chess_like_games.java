...
public class GUI_for_chess_like_games extends JFrame {
    ...
    private final JLabel turnLabel = new JLabel("src.Player 2's Turn");
    private final JLabel playerTowWinsLabel = new JLabel("♟ src.Player 2 Wins: 0");
    private final JLabel playerOneWinsLabel = new JLabel("♙ src.Player 1 Wins: 0");
    ...
    private void updateBoard() {
        ...
        if (gameLogic.isSecondPlayerTurn()) {
            turnLabel.setText("src.Player 2's Turn");
        } else {
            turnLabel.setText("src.Player 1's Turn");
        }
    ...
    private void updateWinsLabels(int attackerWins, int defenderWins) {
        playerTowWinsLabel.setText("♟ src.Player 2 Wins: " + attackerWins);
        playerOneWinsLabel.setText("♙ src.Player 1 Wins: " + defenderWins);
    }
